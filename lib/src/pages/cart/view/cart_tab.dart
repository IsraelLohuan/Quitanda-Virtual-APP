            ...
            child: Column(
              ...
              children: [
                ...
                GetBuilder<CartController>(
                  builder: (controller) {
                    return Text(
                      UtilsServices.priceToCurrecy(controller.cartTotalPrice()), 
                      style: TextStyle(
                        fontSize: 23, 
                        color: CustomColors.customSwatchColor,
                  ...
                  child: GetBuilder<CartController>(
                    builder: (controller) {
                      return ElevatedButton(
                        ...
                        child: controller.isCheckoutLoading ? const CircularProgressIndicator() : const Text('Concluir pedido', style: TextStyle(fontSize: 18),),
                      );
                    }
                  ),
                )
